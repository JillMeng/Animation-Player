...
/**
 * This is an interface of animationbuilder to build animation.
 *
...
public interface AnimationBuilder<Model> {
   ...
   */
  AnimationBuilder<Model> setBounds(int x, int y, int width, int height);
   ...
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Model> declareShape(String name, String type);
   ...
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Model> addMotion(String name,
